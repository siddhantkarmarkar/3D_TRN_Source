...
T_hot_in = 118 #Celsius
T_cold_in = 30 # Celsius
P_hot_in = 90#Bar
P_cold_in = 210 #Bar
m_channel = 51.3e-5# channel mass flow rate, Kg/sec
##################################
# Geometric Inputs
t = 3#mm
w = 3#mm
d= 3#Hydraulic diameter of channel - mm (square channel)
L = 0.455# metre, Length
##################################
# Material inputs
hot_fluid = 'co2'
cold_fluid = 'co2'
k_solid =  19# w/mk-Copper at 350 Celsius
...
a =20 # number of nodes in x direction(direction of flow)
b_ch = 10 # pair of hot and cold channels along height (Y direction) - 1 pair of channels => b_ch =1
